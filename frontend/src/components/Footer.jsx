    ...
    <footer className="footer">
      <div className="container">
        <div className="footer__grid">
          <div className="footer__brand">
            <Link to="/" className="footer__logo">
              <Feather size={20} />
              <span>Ink<span className="gradient-text">Space</span></span>
            </Link>
            <p className="footer__tagline">
              A place where ideas take shape.<br />Write freely. Read deeply.
            </p>
        ...
        <div className="footer__bottom">
          <p>© {new Date().getFullYear()} InkSpace. All rights reserved.</p>
          <p className="footer__heart">
            Made with <Heart size={13} fill="currentColor" /> for passionate writers
          </p>
        </div>
      </div>
    </footer>
